...
export const tests: Test[] = [
  ...
  },
  {
    ...
    mode: "random",
    structure: [
      { skill: "grammar", type: "mcq", level: "A2", count: 20, difficulty: "mixed" },
      { skill: "vocabulary", type: "fill", level: "A2", count: 10, difficulty: "medium" },
    ],
    registered: 18,
    submitted: 0,
    graded: 0,
  ...
  },
  {
    ...
    closeAt: days(5),
    mode: "fixed",
    structure: [{ skill: "vocabulary", type: "mcq", level: "A1", count: 15, difficulty: "easy" }],
    registered: 11,
    submitted: 0,
    graded: 0,
    createdAt: days(-7),
